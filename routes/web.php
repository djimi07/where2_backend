...
//fetch data form googleapi
// Route::get('/getBars/{id}', 'Api\Bar_RestaurantController@getBars');
Route::get('/getBars', 'Api\Bar_RestaurantController@getBars');
Route::get('/insertzipcode', 'Api\Bar_RestaurantController@insertzipcode');
Route::get('/cronGetPlaces', 'Api\Bar_RestaurantController@cronGetPlaces');
Route::get('/cronNextPlaces', 'Api\Bar_RestaurantController@cronNextPlaces');
Route::get('/cronbyzip', 'Api\Bar_RestaurantController@cronbyzip');
Route::get('/cronNextByZip', 'Api\Bar_RestaurantController@cronNextByZip');
...
Route::group(['prefix' => 'admin'], function ()
{
    ...
    Route::group(['middleware' => 'AdminViewAuth'], function ()
    {
        ...
        Route::get('/comment_management', 'AdminViewController@comment_view');
