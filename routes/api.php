...
Route::group(['prefix' => 'admin'], function ()
{
    ...
    Route::group(['middleware' => ['AdminAuth', 'auth:api']], function ()
    {
        ...
        //preselectedcomment
        Route::post('/comment/search-api', 'PreSelectCommentController@search_comment');
        Route::post('/comment/add-edit-comment', 'PreSelectCommentController@add_edit_comment');
        Route::get('/comment/single_edit/{id}', 'PreSelectCommentController@get_single_edit');
        Route::post('/comment/delete', 'PreSelectCommentController@delete');
...
Route::group([], function ()
{
    ...
    Route::group(['middleware' => 'auth:api'], function ()
    {
        ...
        //add favourite bar
        Route::post('/favourite_bar', 'Api\FavouriteController@add_fav_bar');
        //version2
        Route::group(['prefix' => 'v2'], function ()
        {
            Route::post('/upload_user_image', 'Api\UserController@upload_user_image_with_id');
            ...
            //add favourite bar
            Route::post('/favourite_bar', 'Api\FavouriteController@add_fav_bar');
            Route::post('/notification', 'Api\InviteControllerV2@notification');
        }
        );
