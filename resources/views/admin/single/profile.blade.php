                    ...
                    <form id="form_id">
                        ...
                        <div class="profile-body editable">
                            <div class="profile-img">
                                <div class="form-group">
                                    ...
                                    <label class="upld-label">
                                        <input type="file" onchange="update_profile_image()" name="userProfilePicture"
                                    ...
                                    <input type="hidden" name="image" id="image"
                                        value="@if(isset($auth_user->image)){{ $auth_user->image }}@endif">
                                </div>
                            </div>
                            <div class="profile-text">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="lastName" class="form-control" id="lastName"
                                                ...
                                                value="@if(isset($auth_user->lastName)){{ $auth_user->lastName }}@endif"
                                                required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <button type="button" id="form_id_btn" onclick="update_profile('form_id_btn')"
                                        class="btn btn-primary update-btn margin-r-5 form-custom-btn">Submit
                                    </button>
...
function update_profile(form_id) {
    ...
    var url = api_url + 'update-profile';
...
function update_profile_image() {
    ...
    var fd = new FormData();
    fd.append('userProfilePicture', image.files[0]);
