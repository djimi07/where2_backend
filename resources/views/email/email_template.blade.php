...
<div style="width:100%;max-width:600px;margin:0 auto;font-family: lato,trebuchet ms,helvetica,arial, sans-serif;">
    ...
    <div style="padding:30px 20px;text-align: center">
        <img src="{{ url('/') }}/public/default_image/logo_color.svg" alt="" style="width:100%;max-width: 250px;display: inline-block;">
    </div>
    ...
    @if(isset($link) && !empty($link))
        <div style="text-align: center;padding: 0 15px">
            <a href="{{ $link }}" target="_blank" style="background-color:#4bc5f8;border: 0px solid #fff;border-radius: 5px;color: #fff;display: inline-block;font-weight: bold;text-align: center;text-decoration: none;width: auto;margin: 0 auto;padding: 10px 10px;width: 100%;font-size: 20px;">
                Click
            </a>
        </div>
    ...
    @endif
    <div style="padding:25px 15px 25px 15px;border-top:2px solid #4bc5f8">
        <p style="width:100%;max-width:500px;margin:0 auto 25px auto;font-size:12px;text-align:center;color:#000">Copyright &copy; 2020 Housefly.</p>
