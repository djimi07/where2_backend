                ...
                @if(isset($auth_user->id))
                    ...
                    <li class="dropdown notifications-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="footer"><a href="{{ url('/owner/notification') }}">View all</a></li>
                        </ul>
                    </li>
                @endif
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            <p>
                                <a class="heading"
                                   href="{{ url('owner/profile') }}">Owner</a>
                        ...
                        <li class="user-footer">
                            <div class="link-list">
                                <a href="{{ url('owner/profile') }}"><i class="fa fa-user"></i> View Profile</a>
                                <a href="{{ url('owner/change-password') }}"><i class="fa fa-lock"></i> Change
                                    Password</a>
