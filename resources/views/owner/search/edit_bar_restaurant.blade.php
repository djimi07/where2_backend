...
<form id="add_edit_form_data" role="form" method="Post" autocomplete="off" role="form" enctype="multipart/form-data">
    ...
    {{--<div class="form-group row">
        <div class="col-md-6">
            ...
            <input type="text" readonly name="name" class="form-control" id="firstName" placeholder="Enter Bar Name"
        ...
        <div class="col-md-6">
            ...
            <input type="text" readonly name="phone" class="form-control" id="phone"
                onKeyPress="if(this.value.length==14) return false;" @if(isset($data->phone) && !empty($data->phone))
            @endif
    ...
    <div class="form-group row">
        <div class="col-md-6">
            ...
            <input type="text" readonly name="address" class="form-control" id="Address" placeholder=" Enter Address"
        ...
        <div class="col-md-6">
            ...
            <input type="text" readonly name="zipCode" class="form-control" id="zip_code" placeholder="Enter zip code"
    ...
    <div class="form-group row">
        <div class="col-md-4">
            ...
            <input type="text" readonly name="country" class="form-control" id="country" placeholder=" Enter Country"
                value="@if(isset($data->country)){{ $data->country }}@endif">

        </div>
        <div class="col-md-4">
            <label for="userFullAddress">State</label>
            <input type="text" readonly name="state" class="form-control" id="state" placeholder=" Enter State"
                value="@if(isset($data->state)){{ $data->state }}@endif">

        </div>
        <div class="col-md-4">
            <label for="city">City</label>
            <input type="text" readonly name="city" class="form-control" id="city" placeholder=" Enter City"
    ...
    <div class="form-group row">
        <div class="col-md-6">
            ...
            <input type="text" readonly name="latitude" class="form-control" id="Latitude" placeholder=" Enter Latitude"
        ...
        <div class="col-md-6">
            ...
            <input type="text" readonly name="longitude" class="form-control" id="longitude"
                placeholder=" Enter Longitude" value="@if(isset($data->longitude)){{ $data->longitude }}@endif">
        </div>
    </div>
    <div class="form-group row">
        <div class="col-md-6">
            <label for="userAddress">Distance</label>
            <input type="text" readonly name="distance" class="form-control" id="distance" placeholder="Enter Distance"
                value="@if(isset($data->distance)){{ $data->distance }}@endif">

        </div>
        <div class="col-md-6">
            <label for="userAddress">Rating</label>
            <input type="text" readonly name="rating" class="form-control" id="rating" placeholder="Enter Rating"
    ...
    <div class="form-group row">
        ...
        <div class=" form-group img-wrap col-md-4" id="search_image_section_{{$xx->imageId}}">
            <span class="close"><i class="fa fa-remove" onclick="remove_image('{{$xx->imageId}}','{{$xx->restaurantId}}')"
