@extends('owner.layouts.login_master')
@section('page_title')
@if(isset($page_title))
{{ $page_title }}
@else
    ...
    <form id="form_id" onSubmit="return false;" autocomplete="off">
        ...
        <div class="body bg-gray">
            ...
            <div class="form-group">
                <input type="text" name="userMobile" id="userMobile" class="form-control"  onKeyPress="if(this.value.length==10) return false;"  placeholder="Phone Number" />
            </div>
            <div class="form-group">
        ...
        <div class="footer">
            ...
            <a href="{{ url('owner') }}">Back To Sign-In</a>
...
<div class="form-box" id="otp_form" style="display:none">
    ...
    <div class="body bg-gray">
        ...
        <div class="form-group text-center">
            <button id="ver_id_btn" class="btn bg-olive btn-block" onclick="otp_verify('ver_id')">Submit</button>
    ...
    if(code){
        window.confirmationResult.confirm(code)
            .then(function(result) {
                ...
                var url = "{{ url('/owner/password-reset') }}";
